...
Bên cạnh đó $$k$$ tối đa là $$max$$.

Vậy ta được ĐPT: $$O(max^4)$$.
...
Ta tạo đồ thị $$2001$$ đỉnh. Từ $$u$$ có cạnh nối đến $$u + a_i - n$$. Ta cần tìm chu trình chứa đỉnh $$0$$ ngắn nhất. Ta chỉ đơn giản tìm đường đi ngắn nhất từ $$0$$ đến mọi đỉnh. Với mỗi $$i$$, lấy khoảng cách ngắn nhất từ $$0$$ đến $$n - a_i$$. Đáp án là khoảng cách ngắn nhất đó $$+1$$ vì ta chỉ cần thêm $$a_i - n$$ là thành chu trình.
...
Với mỗi truy vấn, ta for tất cả các xâu con và tính xem có bao cách khiến xâu con thành xâu đối xứng và có bao xâu nhận nó là xâu đối xứng. 
