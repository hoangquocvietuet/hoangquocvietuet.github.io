...
Duyệt đoạn $$[l, r]$$ để đánh đấu. Mỗi lần nã đại bác chỉ cần quan tâm xem điểm đó có bị đánh dấu không.
...
Mình chỉ cần quan tâm các toạ độ là đầu mút. Do đó ta rời rạc hoá để tìm các toạ độ mới.
...
Ngoài ra còn cách gọi $$dp[i][j][0/1]$$ là đáp số nếu xét $$i$$ phần tử đầu và $$j$$ phần tử cuối và mình đang nhóm $$a_i$$ với một đoạn dãy $$b$$ hoặc $$b_j$$ với một đoạn dãy $$a$$. Các em tự nghĩ thêm :) 
